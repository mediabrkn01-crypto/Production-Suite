...
(function () {
  ...
  var CSS = [
    ...
    '.be-mnav{display:flex;position:fixed;left:0;right:0;bottom:0;z-index:150;background:var(--bem-bg);',
    'border-top:1px solid var(--bem-border);padding-bottom:env(safe-area-inset-bottom,0px);box-shadow:0 -6px 20px rgba(0,0,0,.5);}',
    '.be-mnav-item{flex:1;min-width:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:3px;',
    'height:60px;background:none;border:none;color:var(--bem-muted);font-size:10px;font-weight:600;cursor:pointer;padding:0 2px;-webkit-tap-highlight-color:transparent;}',
    '.be-mnav-item svg{width:21px;height:21px;}',
    '.be-mnav-item[data-active]{color:var(--bem-accent);}',
    '.be-mnav-item[data-active]::before{content:"";position:absolute;top:0;width:26px;height:3px;border-radius:0 0 3px 3px;background:var(--bem-accent);}',
