...
// is exactly when the spec says the NEW marker may be cleared.
        async function downloadHRPayslip(id, btnEl) {
            ...
            try {
                ...
                if (window.MyWorkspace && document.getElementById('mw-payslips')) window.MyWorkspace.open('payslips'); // re-render so the NEW marker disappears from this row too
...
// My Workspace (profile, attendance, leave, documents, payslips, announcements, team) now lives in
// the shared my-workspace.js module used identically by index.html, academics.html and sales.html.
